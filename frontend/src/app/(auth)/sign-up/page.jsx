...
const SignUp = () => {
	...
	async function onSubmit(values) {
		setLoading(true);
		try {
			const { data } = await axiosInstance.post("/api/v1/auth/register", values);
		...
		<div>
			<div className=''>
				<div className='mx-auto max-w-screen-2xl px-4 md:px-8'>
					<h2 className='mb-4 mt-8 text-center text-2xl font-bold text-blue-500 md:mb-8 lg:text-3xl'>
						Sign Up
					</h2>
